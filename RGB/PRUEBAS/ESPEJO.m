...
global activated
activated=1;
vid=videoinput('winvideo',1,'RGB24_320x240','Tag','Webcam');
axes(handles.axes1);
set(vid,'ReturnedColorSpace','rgb');
hImage1 = image(zeros(240,320,3));
...
%     imframe(121:360,161:480,:)=imframe(1:2:end,1:2:end,:);
    imframe(121:360,161:480,:)=(imframe(121:360,161:480,:)+im)/2;
